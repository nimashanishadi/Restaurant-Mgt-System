    ...
    <body data-spy="scroll" data-target="#template-navbar">
        ...
        <section id="header-slider" class="owl-carousel">
         @foreach($sliders as $slider)
                <div class="img-responsive" style="background-image: url({{asset('storage/upload/'.$slider->image)}});  background-size: cover; frameborder=0;">
                    ...
                    <div class="row">  
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <li class="item" id="{{$item->category->slug}}" >
                                <a href="#">
                            <img src="{{URL::asset('storage/upload/'.$item->image)}}" alt="" class="image-responsive" style="height:300px; width:369px;"/>
                    ...
                    <div class=" section-content">
                        <div class="row">
                            <div class="col-md-5 col-sm-6">
                                <form class="reservation-form" method="post" action="{{route('reservation.send')}}">
                                    {{csrf_field()}}
                                    <div class="row">
            ...
            <div class="container-fluid color-bg">
                <div class="row dis-table">
                    ...
                    <div class="col-xs-6 col-sm-6 dis-table-cell">
                        <div class="section-content">
                            <p>Ranweli Road, Angampitiya, Waikkal</p>
                            <p>+44 12 213584</p>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2019 <a href="#">Mamma's Kitchen.</a> Developed by <a href="http://themewagon.com/"  target="_blank">Nimasha Fdo</a>
                            </p>
                        </div>
                    </div>
                </div>
